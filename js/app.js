                ...
                function initSpollerBody(spollersBlock, hideSpollerBody = true) {
                    ...
                    if (spollerTitles.length) {
                        ...
                        spollerTitles.forEach((spollerTitle => {
                            if (hideSpollerBody) {
                                if (spollerTitle.classList.contains("_spoller-active")) spollerTitle.setAttribute("aria-expanded", true); else spollerTitle.setAttribute("aria-expanded", false);
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            if (spollerTitle.classList.contains("_spoller-active")) spollerTitle.setAttribute("aria-expanded", false);
